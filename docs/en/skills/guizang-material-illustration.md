...
<div class="os-detail-meta"><span class="os-detail-cat">Image Creation · New Media</span><span class="os-tag">Illustration</span><span class="os-tag">Explainer Image</span><span class="os-tag">Chart Beautification</span><span class="os-tag">Chinese Labels</span></div>

> Turn articles, screenshots, data and concepts into Guizang-style material illustrations with Chinese labels that actually explain.

## Video Demo

<div class="os-video"><iframe src="https://open.douyin.com/player/video?vid=7660055506572119338&amp;autoplay=0" title="歸藏的材质插画 Skill 介绍" loading="lazy" scrolling="no" frameborder="0" allowfullscreen allow="autoplay; fullscreen; picture-in-picture"></iframe></div>

[Watch on the original platform ↗](https://www.douyin.com/video/7660055506572119338){ target="_blank" }
